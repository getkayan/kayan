...
func NewRegistrationManager(repo IdentityRepository) *RegistrationManager {
...
func (m *RegistrationManager) Submit(ctx context.Context, method string, traits identity.JSON, secret string) (*identity.Identity, error) {
